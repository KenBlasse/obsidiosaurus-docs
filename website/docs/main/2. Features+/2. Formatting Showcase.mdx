...
Highlighting: <mark>Highlighted text</mark> — syntax `==text==` (converted to `<mark>`)
...
### Standard image
![Obsidiosaurus Logo](/assets/obsidiosaurus_sidebar_icon.webp)

### Resized image
![Success notification](/assets/obsidiosaurus_run_sucess_notifaction_2_400.webp)
