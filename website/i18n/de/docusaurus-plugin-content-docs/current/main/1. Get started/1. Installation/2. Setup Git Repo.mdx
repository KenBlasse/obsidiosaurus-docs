...
ir empfehlen dringend, ein Git-Repository für effiziente Versionierung zu nutzen. Du kannst jeden
it-Anbieter verwenden — in diesem Tutorial nutzen wir GitHub. GitHub ist nicht nur die
eliebteste Wahl, sondern bietet zusätzlich Website-Hosting über GitHub Pages und eine
utomatisierte Release-Pipeline.
:::
